                ...
                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                    ...
                    <tbody>
                        ...
                        <tr class="has-text-centered" >
                            ...
                            <td>
                                <div class="control">
                                    <input class="input sale_input-cant has-text-centered" value="<?php echo $productos['venta_detalle_cantidad']; ?>" id="sale_input_<?php echo str_replace(" ", "_", $productos['producto_codigo']); ?>" type="number" style="max-width: 80px;">
                                </div>
                            </td>
...
<script>
    ...
    function buscar_codigo(){
        ...
        if(input_codigo!=""){
            ...
            document.getElementById("sale-barcode-input").focus();
