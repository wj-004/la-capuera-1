		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					...
					<input class="input" type="text" name="producto_codigo" pattern="[a-zA-Z0-9- ]{1,77}" maxlength="77" required id="codigo_barra_input">
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		document.getElementById("codigo_barra_input").focus();
	});
</script>